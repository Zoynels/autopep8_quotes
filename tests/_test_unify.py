...
"""Test suite for autopep8_quotes."""
...
class TestUnits(unittest.TestCase):
    ...
    def test_autopep8_quotes_quotes(self):
        self.assertEqual("'foo'",
                         autopep8_quotes.autopep8_quotes_quotes('"foo"',
                                                                preferred_quote="'"))
    ...
    def test_autopep8_quotes_quotes_should_avoid_some_cases(self):
        self.assertEqual('''"foo's"''',
                         autopep8_quotes.autopep8_quotes_quotes('''"foo's"''',
                                                                preferred_quote="'"))
    ...
    def test_detect_encoding_with_bad_encoding(self):
        with temporary_file('# -*- coding: blah -*-\n') as filename:
            self.assertEqual('latin-1',
                             autopep8_quotes.detect_encoding(filename))

    def test_format_code(self):
        self.assertEqual("x = 'abc' \\\n'next'\n",
                         autopep8_quotes.format_code('x = "abc" \\\n"next"\n',
                                                     preferred_quote="'"))
    ...
    def test_format_code_with_syntax_error(self):
        self.assertEqual('foo("abc"\n',
                         autopep8_quotes.format_code('foo("abc"\n',
                                                     preferred_quote="'"))
...
class TestUnitsWithFstrings(unittest.TestCase):
    ...
    def test_autopep8_quotes_quotes(self):
        self.assertEqual("f'foo'",
                         autopep8_quotes.autopep8_quotes_quotes('f"foo"',
                                                                preferred_quote="'"))
    ...
    def test_autopep8_quotes_quotes_should_avoid_some_cases(self):
        self.assertEqual('''f"foo's"''',
                         autopep8_quotes.autopep8_quotes_quotes('''f"foo's"''',
                                                                preferred_quote="'"))
    ...
    def test_format_code(self):
        self.assertEqual("x = f'abc' \\\nf'next'\n",
                         autopep8_quotes.format_code('x = f"abc" \\\nf"next"\n',
                                                     preferred_quote="'"))
    ...
    def test_format_code_with_syntax_error(self):
        self.assertEqual('foo(f"abc"\n',
                         autopep8_quotes.format_code('foo(f"abc"\n',
                                                     preferred_quote="'"))
...
class TestUnitsWithRawStrings(unittest.TestCase):
    ...
    def test_autopep8_quotes_quotes(self):
        self.assertEqual("r'foo'",
                         autopep8_quotes.autopep8_quotes_quotes('r"foo"',
                                                                preferred_quote="'"))
    ...
    def test_autopep8_quotes_quotes_should_avoid_some_cases(self):
        self.assertEqual('''r"foo's"''',
                         autopep8_quotes.autopep8_quotes_quotes('''r"foo's"''',
                                                                preferred_quote="'"))

        self.assertEqual('''r"""\\t"""''',
                         autopep8_quotes.autopep8_quotes_quotes('''r"""\\t"""''',
                                                                preferred_quote="'"))

    def test_format_code(self):
        self.assertEqual("x = r'abc' \\\nr'next'\n",
                         autopep8_quotes.format_code('x = r"abc" \\\nr"next"\n',
                                                     preferred_quote="'"))
    ...
    def test_format_code_with_syntax_error(self):
        self.assertEqual('foo(r"Tabs \t, new lines \n."\n',
                         autopep8_quotes.format_code('foo(r"Tabs \t, new lines \n."\n',
                                                     preferred_quote="'"))
...
class TestUnitsWithUnicodeStrings(unittest.TestCase):
    ...
    def test_autopep8_quotes_quotes(self):
        self.assertEqual("u'foo'",
                         autopep8_quotes.autopep8_quotes_quotes('u"foo"',
                                                                preferred_quote="'"))
    ...
    def test_autopep8_quotes_quotes_should_avoid_some_cases(self):
        self.assertEqual('''u"foo's"''',
                         autopep8_quotes.autopep8_quotes_quotes('''u"foo's"''',
                                                                preferred_quote="'"))
    ...
    def test_format_code(self):
        self.assertEqual("x = u'abc' \\\nu'next'\n",
                         autopep8_quotes.format_code('x = u"abc" \\\nu"next"\n',
                                                     preferred_quote="'"))
    ...
    def test_format_code_with_syntax_error(self):
        self.assertEqual('foo(u"abc"\n',
                         autopep8_quotes.format_code('foo(u"abc"\n',
                                                     preferred_quote="'"))
...
class TestUnitsWithByteStrings(unittest.TestCase):
    ...
    def test_autopep8_quotes_quotes(self):
        self.assertEqual("b'foo'",
                         autopep8_quotes.autopep8_quotes_quotes('b"foo"',
                                                                preferred_quote="'"))
    ...
    def test_autopep8_quotes_quotes_should_avoid_some_cases(self):
        self.assertEqual('''b"foo's"''',
                         autopep8_quotes.autopep8_quotes_quotes('''b"foo's"''',
                                                                preferred_quote="'"))
    ...
    def test_format_code(self):
        self.assertEqual("x = b'abc' \\\nb'next'\n",
                         autopep8_quotes.format_code('x = b"abc" \\\nb"next"\n',
                                                     preferred_quote="'"))
    ...
    def test_format_code_with_syntax_error(self):
        self.assertEqual('foo(b"abc"\n',
                         autopep8_quotes.format_code('foo(b"abc"\n',
                                                     preferred_quote="'"))
...
''') as filename:
            ...
            self.assertEqual(
                autopep8_quotes._main(argv=['my_fake_program', filename],
...
''') as filename:
            output_file = io.StringIO()
            self.assertEqual(
                autopep8_quotes._main(argv=['my_fake_program', '--check-only', filename],
                                      standard_out=output_file,
                                      standard_error=None),
                1,
            )
...
''', '\n'.join(output_file.getvalue().split('\n')[2:]))
    ...
    def test_diff_with_missing_file(self):
        ...
        self.assertEqual(
            1,
            autopep8_quotes._main(argv=['my_fake_program',
...
''') as filename:
            output_file = io.StringIO()
            self.assertEqual(
                autopep8_quotes._main(argv=['my_fake_program', '--in-place', filename],
                                      standard_out=output_file,
                                      standard_error=None),
                None,
            )
